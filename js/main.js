var loginFormWrapper = document.getElementsByClassName("mercury__login")[0];
var loginForm = document.getElementById("loginForm");
var emailInputElement = loginForm.getElementsByClassName(
  "login__form-email"
)[0];
...
function setProfile(profileData) {
  ...
  document.getElementsByClassName("mercury")[0].appendChild(el);
}
